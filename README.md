...
- **Multilingual Support** — Available in English, French, Spanish, and Swahili, making content accessible to non-English-speaking learners globally
- **Customisable Interface** — Adjustable font sizes, colour themes, colour-blind modes, light/dark mode, and full keyboard navigation support
- **Screen Reader & Text-to-Speech** — Built-in assistive technology compatibility for visually impaired users
- **Offline Mode & Low-Bandwidth Optimisation** — Lessons and modules can be downloaded for offline use; a low-bandwidth mode supports students with limited internet access
...
The project was delivered across 4 Agile Scrum sprints:

1. **Sprint 1** — Requirements gathering, accessibility-focused wireframes and UI design
2. **Sprint 2** — Backend development: Java Spring Boot, database setup, user data and accessibility preference storage
3. **Sprint 3** — Frontend development: React.js UI with text-to-speech, adjustable font sizes, and alternative image text
4. **Sprint 4** — API testing via Postman, assistive technology compatibility checks, usability refinement
